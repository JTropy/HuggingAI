...
func TokenAuth() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		if tokenGroup != "" {
			...
			if ratio_setting.IsOwnerGroup(tokenGroup) && !isAdmin {
				abortWithOpenAiMessage(c, http.StatusForbidden, "owner 分组仅允许管理员或 root 用户使用")
				return
			}
			...
			if !service.CanUseTokenGroup(isAdmin, userGroup, tokenGroup) {
